...
# packing_algo.print_matrix(original, "Original Matrix")
...
# print("Final Value Matrix post pad\n",current_matrix)
# packing_algo.print_matrix(weights, "Final Value Matrix")
...
accum = np.zeros((weights_shape[0]))
